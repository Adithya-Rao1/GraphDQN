...
from ADMET.physchem import compute_physicochemical_properties
...
class ADMETModel:
    ...
    def __init__(
        ...
        drugbank_path: Optional[Union[Path, str]] = DEFAULT_DRUGBANK_PATH,
    ...
    @property
    def atc_code(self) -> Optional[str]:
        """Get the ATC code."""
        return self._atc_code

    @atc_code.setter
    def atc_code(self, atc_code: Optional[str]) -> None:
    ...
    def predict(self, smiles: Union[str, List[str]]) -> Union[Dict[str, float], pd.DataFrame]:
